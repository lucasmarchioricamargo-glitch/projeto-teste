...
<!-- AIOX-MANAGED-START: digital-performance-squad -->
## Digital Performance Squad

Squad especializada em performance digital — landing pages, funis de conversão, tráfego pago, SEO e CRM.

### Ativação

Use `@agent-name` para ativar um agente. Comandos usam prefixo `*`.

| Agente | Persona | Escopo Principal |
|--------|---------|------------------|
| `@conversion-copywriter` | Rex | Copy de vendas, headlines, VSL, emails e anúncios |
| `@funnel-architect` | Finn | Arquitetura de funis e jornada do cliente |
| `@landing-page-designer` | Lana | Design de landing pages, VSL pages e wireframes |
| `@frontend-developer` | Dev | Implementação técnica, GTM, pixels e performance |
| `@paid-traffic-strategist` | Travis | Estratégia e otimização de Meta Ads e Google Ads |
| `@seo-specialist` | Sage | SEO técnico, conteúdo e backlinks |
| `@cro-analyst` | Cora | Analytics, testes A/B e otimização de conversão |
| `@brand-strategist` | Bran | Branding, posicionamento e personas |
| `@automation-crm-specialist` | Auto | CRM, automações, pipelines e integrações |
| `@performance-analyst` | Perf | Consolidação de dados e inteligência de crescimento |
| `@ux-ui-designer` | Uma | UX, UI, design systems e prototipação |
| `@storytelling-strategist` | Story | Narrativas, storytelling de marca e VSL narrativa |

### Localização

```
squads/digital-performance-squad/
├── squad.yaml          # Manifest (version 1.0.0, slashPrefix: digital-performance)
├── agents/             # 12 arquivos de persona
├── tasks/              # 58 tasks task-first
...
```
<!-- AIOX-MANAGED-END: digital-performance-squad -->
