...
description: Gera prompts otimizados para criação e edição de imagens com gpt-image-2. Use quando a squad precisar de qualquer asset visual — logo, infográfico, anúncio, mockup de UI, foto de produto, visual educacional, slide, comic strip, cartão, merch — ou quando alguém disser "gera uma imagem", "cria um logo", "faz um infográfico", "prompt pra IA", "mockup visual", "criativo de marketing" ou qualquer variação. Ideal para @ux-design-expert ao criar referências visuais e mockups, e para @pm ao produzir criativos de ads e materiais de apresentação.
---
